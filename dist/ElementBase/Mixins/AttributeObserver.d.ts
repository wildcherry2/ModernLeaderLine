...
export declare function attributeObserverMixin<T extends AttributeObservableCtor>(ctor: T): (abstract new (...args: any[]) => {
    addAttributeChangedCallback(attribute_name: string, callback: TAttributeObserverCallback</*elided*/ any>, once?: boolean, call_now?: boolean): void;
    removeAttributeChangedCallback(attribute_name: string, callback: TAttributeObserverCallback</*elided*/ any>, once?: boolean): void;
    ...
    __attribute_observer_data: {
        ...
        callbacks: Map<string, Set<TAttributeObserverCallback</*elided*/ any>>>;
        once_callbacks: Map<string, Set<TAttributeObserverCallback</*elided*/ any>>>;
 ...
 */
export declare function attributeProperty<T extends AttributeObserverMixin, K extends keyof AttributePropertyDefaultConverters>(options: AttributePropertyOptions<T, K>): AttributePropertyDecoratorFactory<T, AttributePropertyDefaultConverters[K]>;
export declare function attributeProperty<T extends AttributeObserverMixin, V>(options: AttributePropertyOptionsWithConverter<T, V>): AttributePropertyDecoratorFactory<T, V>;
export declare function attributeProperty<T extends AttributeObserverMixin>(options?: AttributePropertyOptionsNoConverter<T>): AttributePropertyDecoratorFactory<T, string>;
export declare function attributeProperty<T extends AttributeObserverMixin>(value: ClassAccessorDecoratorTarget<T, string>, context: ClassAccessorDecoratorContext<T, string>): ClassAccessorDecoratorResult<T, string>;
